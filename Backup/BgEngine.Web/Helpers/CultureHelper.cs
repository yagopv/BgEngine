...
namespace System.Web.Helpers
{
    public static class CultureHelper
    {
        ...
        private static readonly IList<string> _cultures = new List<string> {
            "en",     // English NEUTRAL culture. First culture is the DEFAULT
            "es-ES",  // Spanish
            "es"      // Spanish NEUTRAL culture            
        };

        /// <summary>
        /// Returns a valid culture name based on "name" parameter. If "name" is not valid, it returns the default culture "es-ES"
        /// </summary>
