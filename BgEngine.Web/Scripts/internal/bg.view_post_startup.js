...
(function ($) {
    $.view_post_startup = function (loading_message, postid, getposturl, commentcount, scriptspath, culture,usermail, leavecomment) {
        tinyMCE.init({
            mode: "textareas",
            theme: "advanced",
            skin: "cirkuit",
        ...
        $("#related-comment-submit").live("click",function () {
            ...
            if (message != "") {
                ...
                $.post("/Comment/AddRelatedComment/",
        ...
        $(".reply").live("click",function() {         
            ...
            {
                $(".reply").not(this).hide("slow");
                $(".ui-icon",this).removeClass("ui-icon-pencil").addClass("ui-icon-cancel");
                $(this).closest("li.thread").after('<li id="newcomment" class="ui-state-default ui-corner-all ui-helper-margin">' +
                                                '<div class="comment-area ui-helper-width-100pc">' +
                                                    ...
                                                    '<div class="bg-widget-content-right">' +
                                                     ...
                                                     '<div class="bg-input-search ui-helper-margin-top-bottom">' +							
                                                        '<input id="related-comment-submit" title="' +  $(this).attr("id")  + '" type="button" value="' + leavecomment +'" />' +   
                                                     '</div>' +
                                                    '</div>' +
                                                 '</div>' + 
